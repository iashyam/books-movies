...
The framework used in the backend is Go-gin, the databse in mongodb.There is no perticular reason to choose this, except just I wanted it this way. The fronted is build using pure HTML and CSS. Because I still don't know much of typescript. (I should learn it someday.)


This is available [here](booksnmovies.iashyam.in).
